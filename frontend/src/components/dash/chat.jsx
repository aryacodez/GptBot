                    ...
                    <div className="col-7">
                        <div className="card">
                            <div className="card-body">
                                <div id="chat-messages" className="mb-3">User: {message}</div>
                                <div id="chat-messages" className="mb-3">Bot: {response}</div>
                                <form id="chat-form" onSubmit={handleBot}>
                                    <div className="form-group">
                                        <label for="message-input" className="mb-2">Input message:</label>
                                        <input type="text" id="message-input" className="form-control"
                                            placeholder="Enter your query" value={message}
                                            onChange={(e) => setMessage(e.target.value)} />
                                    </div>
                                    <button type="input" className="btn btn-primary mt-2 ps-5 pe-5" >Submit</button>
                                </form>
                            </div>
                        </div>
                    </div>
